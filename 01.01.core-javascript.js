...
// JavaScript's most important date type is the object
// An object is a collection of name/value pairs, or a string to value map
var book = {                // Objects are enclosed by curly braces.
  topic: "JavaScript",      // The property "topic" has value "JavaScript".
  fat: true                 // The property "fat" has value true.
};                          // The curly brace marks the end of the object.

// Access the properties of an object with . or []:
console.log(book.topc);     // => "JavaScript"
console.log(book["fat"]);   // => true: another way to access property values.
book.author = "Flanagan";   // Create new properties by assignment.
book.contets = {};          // {} is an empty oject with no properties.

// JavaScript also supports arrays (numerically indexed lists) of values:
var primes = [2, 3, 5, 7];  // An array of 4 values, deliminted wiht [ and ].
...
// Arrays and objects can old other arrays and objects:
var points = [              // An array with 2 elemnets.
...
// JavaScript define some shorthand arithmetic Operators
var count = 0;              // Define a variable
count++;                    // Increment the variable
count--;                    // Decrement the variable
count += 2;                 // Add 2: same as count = count + 2;
count *= 3;                 // Multiply by 3: same as count = count * 3;
console.log(count);         // => 6:  variable names are expressions too.
...
}                           // Funcitons are enclosed in curly braces
...
};                          // Semicolon marks the end of this assignment

console.log(square(plus1(y)));
                            // => 16: invoke two functions in one expressions
...
points.dist = function() {  // Define method to compute distance between points
  var p1 = this[0];         // First element of array we are invoked on
...
}                           // Pythagorean theorem where Math.sqrt() computes
                            // the square root

console.log(points.dist()); // => 1.414: distance between our two points

// JavaScript statements include conditionals and loops using the syntax of
...
function abs(x) {           // A function to compute the absolute value
  ...
  }                         // Curly braces optionsl when 1 statement in clause
...
function Point(x,y) {       // By convetion, constructors start with capitals
  ...
  this.y = y;               // Store function arguements as object properties
}                           // No return is necessary

// Use a constructor function with the keyword "enw" to create instances
...
// Now the Point object p (and all future Point objects) inheri9t the method r()
